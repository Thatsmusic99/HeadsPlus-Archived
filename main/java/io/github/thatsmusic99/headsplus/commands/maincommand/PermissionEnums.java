...
public enum PermissionEnums {
	...
	HEAD("headsplus.head", "/head", "Spawns in a head."), 
	BLACKLIST_LIST("headsplus.maincommand.blacklist.list", "/hp blacklistl [Page no.]", "Lists all heads in the blacklist."), 
	PURGEDATA("headsplus.maincommand.purgedata", "/hp purgedata", "Purges data.yml and reloads it."), 
	SELLHEAD("headsplus.sellhead", "/sellhead", "Sells the head in your hand."), 
