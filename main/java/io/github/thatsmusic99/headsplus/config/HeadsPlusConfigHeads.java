...
public class HeadsPlusConfigHeads extends ConfigSettings {
	...
	public final List<String> uHeads = new ArrayList<>(Arrays.asList("bat", "cod", "dolphin", "donkey", "drowned", "enderdragon", "elderguardian", "endermite", "evoker", "horse", "llama", "magmacube", "mule", "parrot", "phantom", "polarbear", "pufferfish", "salmon", "shulker", "silverfish", "skeletonhorse", "snowman", "stray", "tropicalfish", "turtle", "vex", "vindicator", "wither", "witherskeleton"));
