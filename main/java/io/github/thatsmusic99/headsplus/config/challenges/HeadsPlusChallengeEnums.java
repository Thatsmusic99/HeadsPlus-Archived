...
public enum HeadsPlusChallengeEnums {
    ...
    PROFIT("profit", "Profit", "&8[&a&lProfit!&8]", Collections.singletonList("Sell a total of 15 heads!"), 15, HeadsPlusChallengeTypes.SELLHEAD, HPChallengeRewardTypes.ECO, 200, 0, HeadsPlusChallengeDifficulty.EASY, "total", 150, 0.0),
    ...
    EVIL_LAUGH("evil_laugh", "\"Nyehehe...\"", "&8[&c&lNyehehe...&8]", Arrays.asList("&7Get a total", "of 60 heads!"), 60, HeadsPlusChallengeTypes.LEADERBOARD, HPChallengeRewardTypes.GIVE_ITEM, Material.DIAMOND, 2, HeadsPlusChallengeDifficulty.MEDIUM, "total", 500, 0.0),
    ...
    DONT_NEED("dont_need", "I don't need this", "&8[&a&lI don't need this!&8]", Arrays.asList("&7Sell 20 creeper", "&7heads, they may", "explode if you don't..."), 20, HeadsPlusChallengeTypes.SELLHEAD, HPChallengeRewardTypes.ECO, 300, 0, HeadsPlusChallengeDifficulty.MEDIUM, "creeper", 400, 0.0),
    STRONGER_STEEL("stronger_steel", "Stronger than Steel", "&8[&c&lStronger than Steel&8]", Arrays.asList("&7Get 15 iron", "golem heads!"), 15, HeadsPlusChallengeTypes.LEADERBOARD, HPChallengeRewardTypes.GIVE_ITEM, Material.EMERALD, 3, HeadsPlusChallengeDifficulty.MEDIUM, "irongolem", 450, 0.0),
