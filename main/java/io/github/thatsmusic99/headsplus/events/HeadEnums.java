...
public enum HeadEnums {
    ...
    COCONUTB(HeadsPlusConfigHeads.getHeads().getString("coconutBHeadEN"), HeadsPlusConfigHeads.getHeads().getString("coconutBHeadN")),
    COCONUTG(HeadsPlusConfigHeads.getHeads().getString("coconutGHeadEN"), HeadsPlusConfigHeads.getHeads().getString("coconutGHeadN")),
