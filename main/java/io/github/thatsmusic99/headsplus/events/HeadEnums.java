...
public enum HeadEnums {
    ...
    COCONUTB(HeadsPlusConfigHeads.getHeads().getString("brownCoconutHeadEN"), HeadsPlusConfigHeads.getHeads().getString("coconutBHeadN")),
    COCONUTG(HeadsPlusConfigHeads.getHeads().getString("greenCoconutHeadEN"), HeadsPlusConfigHeads.getHeads().getString("coconutGHeadN")),
