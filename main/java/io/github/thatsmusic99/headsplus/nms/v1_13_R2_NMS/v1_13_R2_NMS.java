...
public class v1_13_R2_NMS implements NewNMSManager {
    ...
    public org.bukkit.inventory.ItemStack addNBTTag(Object i) {
        net.minecraft.server.v1_13_R2.ItemStack is = CraftItemStack.asNMSCopy((org.bukkit.inventory.ItemStack) i);
        if (is.getTag() == null) {
    ...
    public String getId(ItemStack id) {
        net.minecraft.server.v1_13_R2.ItemStack i = CraftItemStack.asNMSCopy(id);
        if (i.getTag() != null) {
